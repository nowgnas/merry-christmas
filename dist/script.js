...
scene.background = new THREE.Color( 0xa19778 );
...
mesh.scale.set(0.5,0.5,0.5);
  ...
  mesh.position.x = 150 * Math.sin( n) * Math.cos( t);
  mesh.position.y=Math.random()*(150-(-150))-150;
  mesh.position.z = 150 * Math.cos( n)+Math.floor(Math.random()*40+1);
snow.add( mesh );
...
var material4 = new THREE.MeshBasicMaterial( {side: THREE.BackSide, emissive: 0xd9efff,color: 0xd9efff } );
